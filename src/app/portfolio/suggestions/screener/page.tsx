...
export default function ScreenerPage() {
  ...
  useEffect(() => { fetchResults(); return () => { abortControllerRef.current?.abort(); }; }, []);
  ...
  return (
    <div className="w-full font-sans animation-fade-in space-y-10">
      {/* Header */}
      <div>
        <p className="text-emerald-400 mt-2 font-mono text-sm uppercase tracking-widest">Filter all tracked assets by any metric</p>
      </div>
